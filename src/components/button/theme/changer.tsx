...
import { IChanger } from './type'


const Changer = (props: IChanger) => {
    const { theme, setTheme } = useTheme()
    return (
        <>
            <div className="flex rounded-2xl dark:bg-slate-700 bg-slate-100 ">
                <button className="rounded-2xl dark:bg-slate-700 dark:text-white light:bg-white light:text-black" onClick={() => setTheme('light')}>
                    <label className="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" htmlFor="light-switch">
                ...
                <button className="rounded-2xl dark:bg-slate-700 dark:text-white light:bg-white light:text-black" onClick={() => setTheme('dark')} >
                    <label className="flex items-center justify-center cursor-pointer w-8 h-8 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600/80 rounded-full" htmlFor="light-switch">
